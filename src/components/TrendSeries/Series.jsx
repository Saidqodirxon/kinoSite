            ...
            >
              <div className="relative">
                ...
                <div className="absolute top-2 left-2 bg-yellow-500 text-white rounded-full px-2 py-1 text-xs font-bold flex items-center">
                  <FaStar className="mr-1" /> {seriesItem.rating}
                </div>
              </div>
              <div className="p-4">
                <h3 className="text-lg font-bold mb-2">{seriesItem.title}</h3>
                <div className="flex justify-between text-sm text-gray-600">
                  <p className="flex justify-center">
                    Yili: {seriesItem.releaseYear}{" "}
                    <GoDotFill className="m-[2px]" />
                  </p>
                  <div className="flex items-center">{seriesItem.duration}</div>
                  <div className="flex items-center text-gray-600 text-sm">
                    <FaEye className="mr-1" /> {seriesItem.views}
                  </div>
                </div>
              </div>
            </div>
